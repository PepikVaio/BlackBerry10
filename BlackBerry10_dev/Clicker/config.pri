...
config_pri_assets {
    OTHER_FILES += \
        $$quote($$BASEDIR/assets/Custom/Labels/Custom_Label_01.qml) \
        $$quote($$BASEDIR/assets/Custom/Labels/Custom_Label_02.qml) \
        $$quote($$BASEDIR/assets/Images/popeye.png) \
        $$quote($$BASEDIR/assets/Images/popeye_rest.png) \
...
lupdate_inclusion {
    SOURCES += \
        ...
        $$quote($$BASEDIR/../assets/Custom/Labels/*.qml) \
        $$quote($$BASEDIR/../assets/Custom/Labels/*.js) \
        $$quote($$BASEDIR/../assets/Custom/Labels/*.qs) \
        ...
        $$quote($$BASEDIR/../assets/XML + JSON/Data/*.qml) \
        $$quote($$BASEDIR/../assets/XML + JSON/Data/*.js) \
        $$quote($$BASEDIR/../assets/XML + JSON/Data/*.qs)
