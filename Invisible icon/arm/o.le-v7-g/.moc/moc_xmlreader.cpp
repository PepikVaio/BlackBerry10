/****************************************************************************
** Meta object code from reading C++ file 'xmlreader.hpp'
**
...
#include "../../../src/XmlReader/xmlreader.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'xmlreader.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_XmlReader[] = {
    ...
    "xmlPath,entryType,attribute\0"
    "LoadXML(QString,QString,QString)\0"
};
...
void XmlReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { QVariantList _r = _t->LoadXML((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3])));
